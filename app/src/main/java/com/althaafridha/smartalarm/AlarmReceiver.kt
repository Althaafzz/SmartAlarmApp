...
class AlarmReceiver: BroadcastReceiver() {
    ...
    fun setOneTimeAlarm(context: Context, type: Int, date: String, time: String, message: String) {
        ...
        // date diterima -> 12-3-2022
        // split untuk menghilangkan tanda '-' -> 12 3 2022
    ...
    fun cancelAlarm(context: Context, type: Int, ){
        ...
        // ambil requestCode / ID_ALARM berdasarkan tipe alarm nya
        ...
        Log.i("cancelAlarm", "cancelAlarm: Succes Remove Alarm")
